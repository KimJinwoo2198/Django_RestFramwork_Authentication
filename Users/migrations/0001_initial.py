# Generated by Django 5.1.2 on 2024-12-08 11:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_id', models.BigIntegerField(editable=False, unique=True)),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('phone_number', models.CharField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(message='전화번호는 9자에서 15자의 숫자만 포함할 수 있습니다.', regex='^\\+?1?\\d{9,15}$')])),
                ('service_agreement', models.BooleanField(default=False)),
                ('privacy_agreement', models.BooleanField(default=False)),
                ('promotion_agreement', models.BooleanField(default=False)),
                ...
                ('profile_image', models.ImageField(blank=True, default='defaultprofile.png', upload_to='profile_images/')),
